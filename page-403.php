      ...
      <div class="container text-center">
        ...
        <div class="row h-full">
          <div class="col-12 col-lg-8 offset-lg-2 align-self-center">
            ...
            <h1 class="display-1 hidden-sm-down">403</h1>
            <h1 class="display-4 hidden-md-up">403</h1>
            <br>

            <p class="fs-20 w-400 mx-auto hidden-sm-down">Access to this directory is denied</p>
            <p class="fs-16 w-250 mx-auto hidden-md-up">Access to this directory is denied</p>
